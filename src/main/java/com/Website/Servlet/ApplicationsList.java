...
/**
 * Servlet implementation class ApplicationsList
 */
@WebServlet("/ApplicationsList")
public class ApplicationsList extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		Query qref = sref.createQuery("from ApplicationPojo");
		List lref = qref.list();
